...
module.exports = (token, VERIFY_EMAIL_URL)=>{
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td align="center" style="padding: 56px 56px 28px 56px;" valign="top">
                          <a style="color: #3498DB; text-decoration: none;" href="https://stealth.qaltfi.com"
                            target="_blank">
                            <img style="width: 156px; height: 156px; border: 0;" alt="QAltFi Logo"
                              src="https://stealth.qaltfi.com/img/logo-Q-qaltfi.jpg">
                          </a></td>
                      </tr>
                      <tr>
                          <td align="center" style="padding: 0 56px 28px 56px;" valign="top">
                            <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 20px; color: #333;">
                              Hello, thank you for registering an account at QAltFi.
                            </div>
                          </td>
                        </tr>
                      <tr>
                    ...
                    <tbody>
                      <tr>
                        <td align="center" style="padding: 28px 56px;" valign="top">
                          <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 16px; line-height: 24px; color: #A7ADB5;">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque accusamus, neque officiis eum, quisquam quo qui ullam molestias id unde consequuntur enim, esse quae temporibus cum. Facilis voluptatum suscipit qui!
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td align="center" style="padding: 0 56px 28px 56px;" valign="top">
                          <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 16px; color: #A7ADB5;">
                            If you didn’t regiter, simply delete this email. You won't be subscribed if you don't
                      ...
                      <tr>
                        <td align="center" style="padding: 0 56px 28px 56px;" valign="middle">
                          <span style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 16px; color: #A7ADB5; vertical-align: middle;">
                          Powered by</span>
                          &nbsp;
                          <a style="border: 0;" href="" target="_blank"><img alt="QAltFi" width="70" height="30" style="vertical-align: middle;"
                              src="https://stealth.qaltfi.com/img/logo-skinny-Q-qaltfi.jpg">
                          </a></td>
                      </tr>
                    </tbody>
                  </table>
